        ...
        <div class="col-sm-9 col-md-7 col-lg-5 mx-auto">
            <div class="card card-signin my-5">
                <div class="card-body">
                    ...
                    <form class="form-signin" action="ajouter-un-chien-form.php" method="POST">
                        ...
                        <div class="form-label-group">
                            ...
                            <input type="Date" id="inputNom" name ="date" class="form-control" placeholder="Date" required> 
                        </div>
                        <div class="form-label-group">
                            <label for="inputPays">Téléverser la photo de votre chien</label>
                            <input type="file" id="inputPhoto" name ="photo" class="form-control" placeholder="Téléverser la photo de votre chien" required> 
                        </div>
